...
description: Horizontal scrolling while scrolling up or down
draft: false
category: JavaScript
...
## TL;DR
Don't wanna waste your time reading the post, and just want to start using it in your
React application? Here is 3.5kB package delivery for you:
<div class="mt-5 [&>*]:flex [&>*]:gap-1.5 [&>*]:items-center">
  Link to NPM: [![repo](/images/npm.svg)](https://www.npmjs.com/package/scrollbun)
</div>
